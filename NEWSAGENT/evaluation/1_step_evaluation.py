...
def evaluate_all(
    indices = range(100),
    path_google: str = "Generated_report/1_step_gemma-3-27b-it",
    ...
    # Save outputs
    write_json("evaluation/1_step_eval/per_id_scores.json", results)
    write_json("evaluation/1_step_eval/average_scores.json", avg_scores)
    write_json("evaluation/1_step_eval/f1_scores.json", f1_per_id)
